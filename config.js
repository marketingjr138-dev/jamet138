...
window.GAS_API_URL = ""; // isi dengan URL Web App Google Apps Script JAMET138 kalau sync global sudah siap
...
window.DEFAULT_CONFIG = {
  ...
  "guides": {
    "daftar": [
      ...
      "Pastikan semua data sesuai sebelum submit.",
      "Setelah akun aktif, login menggunakan username dan password."
    ],
    "deposit": [
      "Login ke akun JAMET138.",
      "Pilih menu Deposit.",
    ...
    "transfer": [
      ...
      "Klik transfer, lalu buka game tujuan."
    ],
    "withdraw": [
      "Pastikan saldo sudah berada di saldo utama.",
      "Kalau saldo masih di provider/game, transfer balik dulu ke saldo utama.",
      "Pilih menu Withdraw.",
